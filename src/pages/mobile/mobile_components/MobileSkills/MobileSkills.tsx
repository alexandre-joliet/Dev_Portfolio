...
const MobileSkills = () => {
    ...
    useEffect(() => {
        ...
        const hardList = document.querySelectorAll(".mobile_skills-list-item");
    ...
    return (
        <>
            <section className="mobile_skills-section">
                <h2 className="mobile_skills-title">SKILLS</h2>
                <h3 className="mobile_skills-subtitle">HARD SKILLS</h3>
                <ul className="mobile_skills-list-container">
                    <li className="mobile_skills-list-item">
                        <svg
                            className="mobile_skills-svg"
                            role="img"
                            viewBox="0 0 24 24"
                ...
                <h3 className="mobile_skills-subtitle">SOFT SKILLS</h3>
                <ul className="mobile_skills-list-container">
                    <li className="mobile_skills-list-item-soft">
                        Team spirit
                    </li>
                    <li className="mobile_skills-list-item-soft">
                        Communication
                    </li>
                    <li className="mobile_skills-list-item-soft">Curiosity</li>
                    <li className="mobile_skills-list-item-soft">Creativity</li>
                    <li className="mobile_skills-list-item-soft">
                        Adaptability
                    </li>
                    <li className="mobile_skills-list-item-soft">Reactivity</li>
                    <li className="mobile_skills-list-item-soft">
                        Team Management
                    </li>
                    <li className="mobile_skills-list-item-soft">
