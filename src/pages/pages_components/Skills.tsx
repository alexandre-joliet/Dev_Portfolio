...
const Skills = () => {
    ...
    useEffect(() => {
        const scrollTrigger = ScrollTrigger.create({
            trigger: ".phone_portfolio-skills-section",
        ...
        gsap.to(".phone_portfolio-skills-section", {
        ...
        const hardList = document.querySelectorAll(".phone_skills-list-item");
    ...
    return (
        <>
            <section className="phone_portfolio-skills-section">
                <h2 className="phone_portfolio-skills-title">SKILLS</h2>
                <h3 className="portfolio_section-skills-subtitle">
                    HARD SKILLS
                </h3>
                <ul className="phone_skills-list-container">
                    <li className="phone_skills-list-item">
                        <svg
                            className="phone_skills-svg"
                            role="img"
                            viewBox="0 0 24 24"
                ...
                <ul className="phone_skills-list-container">
                    <li className="phone_skills-list-item-soft">Team spirit</li>
                    <li className="phone_skills-list-item-soft">
                        Communication
                    </li>
                    <li className="phone_skills-list-item-soft">Curiosity</li>
                    <li className="phone_skills-list-item-soft">Creativity</li>
                    <li className="phone_skills-list-item-soft">
                        Adaptability
                    </li>
                    <li className="phone_skills-list-item-soft">Reactivity</li>
                    <li className="phone_skills-list-item-soft">
                        Team Management
                    </li>
                    <li className="phone_skills-list-item-soft">
